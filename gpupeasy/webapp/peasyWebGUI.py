...
# TODO: Refactor once you understand how this works.
# FLASK_APP=peasyWebGUI.py FLASK_DEBUG=1 python -m flask run --port 4004
...
if __name__ == "__main__":
    ...
    # Disable reload to prevent thread concurrency issues
